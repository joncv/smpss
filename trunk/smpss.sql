...
(1, '管理员', '96e79218965eb72c92a549dd5a330112', 1, 1322104606, 1329270866),
(2, 'admin', '21232f297a57a5a743894a0e4a801fc3', 2, 0, 0),
(3, '超级管理员', '96e79218965eb72c92a549dd5a330112', 1, 0, 0);
...
CREATE TABLE IF NOT EXISTS `smpss_category` (
  ...
  PRIMARY KEY (`cat_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='商品分类表' AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `smpss_goods` (
  ...
  `countamount` float NOT NULL COMMENT '商品总进价',
  `salesamount` float NOT NULL COMMENT '销售总额',
...
CREATE TABLE IF NOT EXISTS `smpss_log` (
  ...
  KEY `dateymd` (`dateymd`),
  KEY `user_id` (`user_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='商品管理日志表' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='进货表' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='销售记录表' AUTO_INCREMENT=1 ;
