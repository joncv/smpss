...
(4, '海飞丝去屑洗发水', '6911989262550', 3, 8, 0, '', '', '10.00', '0.00', '12.00', '8.00', 1, '2012-02-08', '2012-03-08', 1, '2012-02-09', 1328779753, '2012-02-10', 1328861274, '', 56.00, 16.00),
...
CREATE TABLE IF NOT EXISTS `smpss_log` (
  ...
  KEY `dateymd` (`dateymd`),
  KEY `user_id` (`user_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='商品管理日志表' AUTO_INCREMENT=28 ;
...
(12, 4, '6911989262550', '海飞丝去屑洗发水', 3, 10, 2, '7.00', '2012-02-09', 1328779778, 0);
...
CREATE TABLE IF NOT EXISTS `smpss_sales` (
  ...
  `dateymd` date NOT NULL,
  `dateline` int(10) NOT NULL,
  `m_discount` float NOT NULL DEFAULT '0' COMMENT '会员优惠金额',
  `p_discount` float NOT NULL DEFAULT '0' COMMENT '促销优惠的金额',
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='销售记录表' AUTO_INCREMENT=11 ;

--
-- 转存表中的数据 `smpss_sales`
--

INSERT INTO `smpss_sales` (`sid`, `goods_id`, `goods_sn`, `goods_name`, `cat_id`, `order_id`, `mid`, `membercardid`, `realname`, `num`, `price`, `out_price`, `dateymd`, `dateline`, `m_discount`, `p_discount`, `refund_type`, `refund_num`, `refund_amount`, `sales_type`) VALUES
(1, 1, '2147483647', '龙凤呈祥', 9, '2147483647', 0, '', '', 3, '10.00', '10.00', '2012-02-08', 1328683147, 0, 0, 0, 0, '0.00', 0),
(2, 2, '2147483647', '龙凤呈祥2', 9, '2147483647', 0, '', '', 2, '10.00', '10.00', '2012-02-08', 1328683147, 0, 0, 0, 0, '0.00', 0),
(3, 1, '6911989262553', '龙凤呈祥', 9, '02081454027451', 2, '22222222', 'kkkkkkkkkk', 1, '9.80', '10.00', '2012-02-08', 1328684042, 0.2, 0, 0, 0, '0.00', 0),
(4, 3, '6911989262551', '茅台酒', 10, '02091602110806', 0, '', '', 2, '200.00', '200.00', '2012-02-09', 1328774531, 0, 0, 2, 1, '200.00', 0),
(5, 3, '6911989262551', '茅台酒', 10, '02091627131571', 0, '', '', 2, '200.00', '200.00', '2012-02-09', 1328776033, 0, 0, 0, 0, '0.00', 0),
(6, 3, '6911989262551', '茅台酒', 10, '02091628521588', 2, '22222222', 'kkkkkkkkkk', 1, '100.00', '200.00', '2012-02-09', 1328776132, 100, 0, 0, 0, '0.00', 0),
(7, 4, '6911989262550', '海飞丝去屑洗发水', 3, '02091730292066', 0, '', '', 2, '8.00', '10.00', '2012-02-09', 1328779829, 0, 2, 0, 0, '0.00', 0),
(8, 1, '6911989262553', '龙凤呈祥', 9, '02101605524789', 0, '', '', 1, '10.00', '10.00', '2012-02-10', 1328861152, 0, 0, 0, 0, '0.00', 0),
(9, 3, '6911989262551', '茅台酒', 10, '02101605524789', 0, '', '', 1, '200.00', '200.00', '2012-02-10', 1328861152, 0, 0, 0, 0, '0.00', 0),
(10, 4, '6911989262550', '海飞丝去屑洗发水', 3, '02101607541067', 0, '', '', 1, '8.00', '10.00', '2012-02-10', 1328861274, 0, 2, 0, 0, '0.00', 0);
